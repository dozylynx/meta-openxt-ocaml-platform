...
python native_virtclass_handler () {
    ...
    if "opam32-native" not in classextend:
        return
    ...
    e.data.setVar("OVERRIDES", e.data.getVar("OVERRIDES", False) + ":virtclass-opam32-native")
    ...
    for prov in provides.split():
        ...
        elif not prov.endswith("-opam32-native"):
            nprovides.append(prov.replace(prov, prov + "-opam32-native"))
        else:
            nprovides.append(prov)
